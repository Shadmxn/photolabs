...
// FavIcon component displays a heart icon that changes based on the 'displayAlert' prop
const FavIcon = ({ displayAlert }) => {
  return (
    <svg width="20" height="17" viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Heart shape path; color changes based on displayAlert prop */}
      <path 
        fill={displayAlert ? "#C80000" : "#EEEEEE"} 
      ...
      />
      {/* If displayAlert is true, render a yellow alert circle */}
      {displayAlert && <circle cx="21" cy="4" r="2.75" fill="#FFFF00" stroke="#C80000" strokeWidth="0.5"/>}
    </svg>
  );
};

export default FavIcon; // Exporting the FavIcon component for use in other parts of the application
